...
/**
 * Alias endpoints for workspace management to align with design docs.
 * Keeps backward compatibility with /v1/private/workspaces-management.
 */
...
@Tag(name = "Workspace Management (Alias)", description = "Workspace CRUD and member management (alias path)")
public class WorkspaceManagementAliasResource {
    ...
    @GET
    @Operation(operationId = "listWorkspacesAlias", summary = "List my workspaces", description = "Get list of workspaces the current user has access to", responses = {
    ...
    public Response listWorkspaces() {
        ...
        log.info("Listing workspaces for user '{}' (alias)", userId);

        List<Workspace> workspaces = workspaceService.getUserWorkspaces(userId);

        log.info("Found '{}' workspaces for user '{}' (alias)", workspaces.size(), userId);
    ...
    @Operation(operationId = "createWorkspaceAlias", summary = "Create workspace", description = "Create a new workspace", responses = {
    ...
    public Response createWorkspace(
        ...
        log.info("Creating workspace '{}' by user '{}' (alias)", request.name(), userId);
        ...
        log.info("Workspace '{}' created successfully (alias)", workspace.name());
    ...
    @Operation(operationId = "getWorkspaceAlias", summary = "Get workspace", description = "Get workspace details by ID", responses = {
    ...
    public Response getWorkspace(@PathParam("id") String id) {
        log.info("Getting workspace '{}' (alias)", id);
        ...
        log.info("Retrieved workspace '{}' (alias)", workspace.name());
    ...
    @Operation(operationId = "updateWorkspaceAlias", summary = "Update workspace", description = "Update workspace details", responses = {
    ...
    public Response updateWorkspace(
        ...
        log.info("Updating workspace '{}' (alias)", id);
        ...
        log.info("Workspace '{}' updated successfully (alias)", workspace.name());
    ...
    @Operation(operationId = "deleteWorkspaceAlias", summary = "Delete workspace", description = "Delete workspace (soft delete)", responses = {
    ...
    public Response deleteWorkspace(@PathParam("id") String id) {
        ...
        log.info("Deleting workspace '{}' (alias)", id);

        workspaceService.deleteWorkspace(id, userId);

        log.info("Workspace '{}' deleted successfully (alias)", id);
    ...
    @Operation(operationId = "listMembersAlias", summary = "List workspace members", description = "Get list of workspace members with user details", responses = {
    ...
    public Response listMembers(@PathParam("id") String workspaceId) {
        log.info("Listing members for workspace '{}' (alias)", workspaceId);
        ...
        log.info("Found '{}' members for workspace '{}' (alias)", memberResponses.size(), workspaceId);
    ...
    @Operation(operationId = "addMemberAlias", summary = "Add workspace member", description = "Add a user as workspace member", responses = {
    ...
    public Response addMember(
        ...
        log.info("Adding member '{}' to workspace '{}' (alias)", request.userId(), workspaceId);

        memberService.addMember(workspaceId, request.userId(), request.roleId(), addedBy);

        log.info("Member '{}' added to workspace '{}' (alias)", request.userId(), workspaceId);
    ...
    @RequiresPermission("WORKSPACE_MEMBER_MANAGE")
    @Operation(operationId = "updateMemberAlias", summary = "Update member role", description = "Update workspace member's role", responses = {
    ...
    public Response updateMember(
        ...
        log.info("Updating member '{}' role in workspace '{}' (alias)", userId, workspaceId);

        memberService.updateMemberRole(workspaceId, userId, request.roleId(), updatedBy);

        log.info("Member '{}' role updated in workspace '{}' (alias)", userId, workspaceId);
    ...
    @Path("/{id}/members/{userId}")
    @RequiresPermission("WORKSPACE_MEMBER_MANAGE")
    @Operation(operationId = "removeMemberAlias", summary = "Remove member", description = "Remove user from workspace", responses = {
    ...
    public Response removeMember(
        ...
        log.info("Removing member '{}' from workspace '{}' (alias)", userId, workspaceId);

        memberService.removeMember(workspaceId, userId);

        log.info("Member '{}' removed from workspace '{}' (alias)", userId, workspaceId);
