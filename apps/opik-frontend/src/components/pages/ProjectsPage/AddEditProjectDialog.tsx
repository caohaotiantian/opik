...
const AddEditProjectDialog: React.FC<AddEditProjectDialogProps> = ({
  ...
  const title = isEdit ? t("projects.dialog.editTitle") : t("projects.dialog.createTitle");
  const buttonText = isEdit ? t("projects.updateProject") : t("projects.createProject");
      ...
      toast({
        ...
        actions: [
          <ToastAction
            ...
            size="sm"
            className="px-0"
            altText={t("projects.dialog.logTracesToProject")}
          ...
          >
            <a
              ...
              rel="noreferrer"
            >
              {t("projects.dialog.logTracesToProject")}
            </a>
          </ToastAction>,
        ],
      });
    ...
    <Dialog open={open} onOpenChange={setOpen}>
      <DialogContent className="max-w-lg sm:max-w-[560px]">
        ...
        <div className="flex flex-col gap-2 pb-4">
          <Label htmlFor="projectName">{t("projects.dialog.nameLabel")}</Label>
          <Input
            id="projectName"
        ...
        <div className="flex flex-col gap-2 pb-4">
          <Label htmlFor="projectDescription">{t("projects.dialog.descriptionLabel")}</Label>
          <Textarea
        ...
        <DialogFooter>
          <DialogClose asChild>
            <Button variant="outline">{t("projects.dialog.cancel")}</Button>
          </DialogClose>
          <DialogClose asChild>
